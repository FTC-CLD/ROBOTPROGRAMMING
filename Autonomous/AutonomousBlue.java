...
@Autonomous(name="OldBlue", group="Linear Opmode")
...
public class AutonomousBlue extends LinearOpMode  {
    ...
    public int GrabSkystone(boolean isRed) {
        ...
        if (r.IsSkystone()) {
            GrabStone();
            r.DriveRotate(-90*alliance);
            r.DriveDistance(0,r.LStone, 0.24);
            return 1;
        }
        r.DriveDistance(1*r.LStone*alliance, 0,0.4);
        GrabStone();
        r.DriveRotate(-90*alliance);
        r.DriveDistance(0,2*r.LStone, 0.24);
        return -3;
    }
    @Override
    public void runOpMode() {
        ...
        r.DriveRamp(0,36, 0.18,0.7);
        r.DriveRamp(0,36, 0.7,0.2);
        r.DriveStop();
        sleep(200);
        // Grabs a skystone
        ...
        r.DriveRamp(10, -45, 0.1, 1);
        r.DriveRamp(0, -45, 1, 0.2);
        r.DriveRotate(0);
