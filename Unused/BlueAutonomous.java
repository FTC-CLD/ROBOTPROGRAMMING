...
public class BlueAutonomous extends LinearOpMode {
    ...
    public final double cmToEncode = 1000.0/58.0, degreesToEncode = 1000.0/102.0, rampingC = 0.9, dt = 0.01, prevtime = -0.01;
    ...
    public void runOpMode() {
        ...
        DriveDistance(30, -30, 0,driverSpeedSlow);

        //Drives under the bridge to earn points
        
        DriveDistance(70, 0, 0,driverSpeedSlow);
