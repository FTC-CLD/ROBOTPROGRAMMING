...
@Autonomous(name="RedAutonomousSimple", group="Linear Opmode")
@Disabled
public class RedAutonomousSimple extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        DriveDistance(0, 60, 0,driverSpeedSlow);
        DriveDistance(50, 0, 0,driverSpeedSlow);
        sleep(15000);
        DriveDistance(-135, 0, 0,driverSpeedSlow);
